          ...
          <div class="header_resize2">
            <div class="now_page_resize">
              <div class="form_title">PROCESO COMPLETO!</div>
              <div class="form_subtitle">Un correo electrónico fue enviado a su cuenta con instrucciones.</div>
              <div class="clr"></div>
            </div>

            <div class="clr"></div>
            <div style="width:100%;height:600px;margin: 0 auto;">
              <div class="form_subtitle">Siga las instrucciones del correo electrónico enviado para recuperar su contraseña.</div>
