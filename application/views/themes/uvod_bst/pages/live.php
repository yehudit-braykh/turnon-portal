...
?>
    ...
    function resize() {
        $('.live_channels_container').height($('#live_player_container').height() - 25);        
    }
    ...
    <!-- content -->
    <div class="container-fluid live_cont">
        <div class="col-sm-12 live_content">

            <div class="col-sm-3" style="background-color:#F00;">
            ...
            <div class="col-sm-9" style="background-color:#00F;">
