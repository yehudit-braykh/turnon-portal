...
<table id='selectDays' cellspacing="0">
    <tr>
        <td colspan="2" class="epg_channel_name" style="border-left: 8px solid #069;">
                    ...
                    if ($country == 'Jamaica') {
                        ...
                        if ($title_arr[0] != '') {
                            ...
                            if ($i == 0) {
                                ...
                                . '<td class="epgData epgDataCurrent" style="border-right:8px solid #069;">' . '<span>' . $title . '</span></td></tr>';
                            } else {
