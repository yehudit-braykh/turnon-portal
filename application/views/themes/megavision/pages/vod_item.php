...
<div class="header_resize2">
        ...
        <div class="content_centered">
            <div class="content_resize">
                <div id="vod_item_player_container">
                    ...
                    <div id="jw_live_player">Cargando...</div>
                </div>
                <div id="vod_item_player_close"><a href="#" onclick="button_close_clickHandler()">Cerrar</a></div>
            ...
            <div class="content_resize">
                ...
                <div id="vod_tab_info">
                    <div id="tab-container" class="tab-container" style="min-width:500px;">
                        <ul class='etabs'>
                            <li class='tab'><a href="#tab1" id="vod_item_sub_menu1">Detalles</a></li>

                            <?php if ($item_media_type == "tv_show") { ?>
                                <li class='tab'><a href="#tab2" id="vod_item_sub_menu2">Episodios</a></li>
                            <?php } ?>  
                        </ul>
            ...
            <div class="vod_related_container">
                <div class="vod_related_title">VIDEOS RELACIONADOS</div>
    ...
    <div class="popup" id="popup_login">
        ...
        <div class="form_title">Necesita estar Registrado para verlo...</div>
        <div class="popup_content">
            ...
            <div class="col_der">
                <form id="register_form" class="popup_form">
                    <div class="popup_title">No está Registrado?</div>
