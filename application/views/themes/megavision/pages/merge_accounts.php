...
<div class="header_resize2" id="login-box">
    ...
    <div id="fb_registration_merge">
        <div class="now_page_resize">
            <div class="form_title">ENLAZAR CUENTAS</div>

            <div class="clr"></div>
        </div>
        <div id="register_by_fb_form">
            <div class="registration_subtitle">El Email <?php echo $fb_profile->content->email; ?> de su cuenta de Facebook ya se encuentra asociada a una cuenta. ¿Le gustaría enlazar los dos?</div>
            <div style="width:100%;height:600px;margin: 0 auto;">
                ...
                <div id="fb_link_container">
                    <div>
                        <label for="password">Por favor, introduzca la contraseña que utiliza en su cuenta ya existente.</label>
                        <input id="password" name="password" class="text" type="password" />

                    </div>
                    <div id="registration_preloader"></div>
                    <p class="form_info">&nbsp;</p>
                    <button id="btn_sign_up_merge" class="send common_btn" style="display: block; margin: 20px auto; width: 200px; float: initial">ENLAZAR CUENTAS</button>
