...
<div class="form-container">
    ...
    <form method="post" id="registerform" class="common-form">
        <ul>
            
            <li>
                <button id="signup_fb_btn" class="fb-btn">REGISTER WITH FACEBOOK</button>
     
                <input id="fb_accept_terms_and_conditions" type="checkbox" class="common-checkbox"/>
                <label>
                    Accept <a href="<?php echo base_url() . 'index.php/static_content/terms_conditions'; ?>" target="_blank" class="terms_and_conditions">Terms and Conditions</a>*
                </label>
            </li>
            <li>
                <span id="fb_info" class="form_info"></span>
            </li>
            <li>
                <div class="or_separator">OR</div>
            </li>
            <li>
            <div class="form-subtitle">Enter your login information</div>
            </li>
            ...
            <li id= "terms_and_conditions">
                ...
                <input id="accept_terms_and_conditions" type="checkbox" class="common-checkbox"/>
                <label>
                    Accept <a href="<?php echo base_url() . 'index.php/static_content/terms_conditions'; ?>" target="_blank" class="terms_and_conditions">Terms and Conditions</a>*
                </label>
            </li>
            ...
            <li class="buttons">
                <button id="btn_sign_up" class="common-button">REGISTER</button>
            </li>
        </ul>
    </form>
</div>
