...
<table id='selectDays' cellspacing="0">
    <tr>
        <td colspan="2" class="epg_channel_name" style="border-left: 8px solid #73bdee;">
...
//                    $next_time = $epg->content->entries[$i+1]->{'pllisting$startTime'} / 1000;
                    ...
                    if ($i == 0) {
                        ...
                        . '<td class="epgData" style="border-right:8px solid #73bdee;">' . '<span>' . $epg->content->entries[$i]->{'pllisting$program'}->{'pl$title'} . '</span></td></tr>';
                    }else{
