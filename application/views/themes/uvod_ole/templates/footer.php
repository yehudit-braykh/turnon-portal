        ...
        <div class="footer">
            ...
            <div class="col-sm-3 footer_left">
                <h5>Video On Demand:</a></h5>
                <p><a href="<?php echo base_url(); ?>">- Movies</a></p>
                <p><a href="<?php echo base_url(); ?>">- Series</a></p>
                <p><a href="<?php echo base_url(); ?>">- Kids</a></p>
            </div>

        	<div class="col-sm-3 footer_left">
        		<h5><a href="<?php echo base_url(); ?>index.php/live_events/main">Live Channels</a></h5>
                <br>
                <h5><a href="<?php echo base_url(); ?>index.php/live_events/main">Events</a></h5>
        	</div>
        	...
        	<div class="col-sm-3 footer_right">
                ...
                <!--<img src="../images/UVOD_logo-footer.png" class="img-responsive logo_footer">-->
        		<span>&copy; 2015 UVOD</span>
