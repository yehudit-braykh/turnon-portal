...
$config['mongo_db']['default']['hostname'] = 'ds033626-a0.mlab.com';
$config['mongo_db']['default']['port'] = '33626';
$config['mongo_db']['default']['username'] = 'clixtv-admin';
$config['mongo_db']['default']['password'] = 'UnivLatam2!';
$config['mongo_db']['default']['database'] = 'clixtv-platform';
