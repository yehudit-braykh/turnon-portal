...
/*-------------------------------------------------------------------------
   DEVELOPMENT UVod Config File
--------------------------------------------------------------------------*/
$config['logo_file'] = 'televisa_logo.png';
$config['logo_width'] = '108px';
$config['logo_height'] = '83px';
$config['logo_top'] = '5px';

$config['menu_highlight_color'] = 'rgb(142,215,252)';
