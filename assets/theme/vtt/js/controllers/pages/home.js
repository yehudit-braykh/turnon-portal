...
vttApp.controller('homeController', function homeController ($scope, $location, videoFactory, $http, $log) {
    ...
    $scope.channels=[{id: 1, title:'Argentina', PosterH:{url:'/assets/theme/vtt/images/logo.png'}},
                     ...
                     {id: 30, title:'Brazil', PosterH:{url:'/assets/theme/vtt/images/logo.png'}},
                     {id: 31, title:'Argentina', PosterH:{url:'/assets/theme/vtt/images/logo.png'}},
                     {id: 32, title:'Argentina', PosterH:{url:'/assets/theme/vtt/images/logo.png'}},
                     {id: 33, title:'Peru', PosterH:{url:'/assets/theme/vtt/images/logo.png'}},
                     {id: 34, title:'Argentina', PosterH:{url:'/assets/theme/vtt/images/logo.png'}},];
