...
vttApp.controller('karaokeController', function karaokeController ($scope, $location, categoriesFactory, videoFactory, $http, $log) {
    ...
    $scope.genre=[{id: 1, title:"Clasicos",PosterH:{url:'/assets/theme/vtt/images/static-images/album5.png'}},
                ...
                $scope.singers=[{id: 1, title:"Artist Name",PosterH:{url:'/assets/theme/vtt/images/static-images/singer5.png'}},
                            {id: 2, title:"Artist Name",PosterH:{url:'/assets/theme/vtt/images/static-images/singer4.png'}},
                            {id: 3, title:"Artist Name",PosterH:{url:'/assets/theme/vtt/images/static-images/singer1.png'}},
                            {id: 4, title:"Artist Name",PosterH:{url:'/assets/theme/vtt/images/static-images/singer3.png'}},
                            {id: 5, title:"Artist Name",PosterH:{url:'/assets/theme/vtt/images/static-images/singer2.png'}},
                            {id: 6, title:"Artist Name",PosterH:{url:'/assets/theme/vtt/images/static-images/singer1.png'}},
                            {id: 7, title:"Artist Name",PosterH:{url:'/assets/theme/vtt/images/static-images/singer5.png'}},
                            {id: 8, title:"Artist Name",PosterH:{url:'/assets/theme/vtt/images/static-images/singer2.png'}},
                            {id: 9, title:"Artist Name",PosterH:{url:'/assets/theme/vtt/images/static-images/singer3.png'}},
                            {id: 10,title:"Artist Name", PosterH:{url:'/assets/theme/vtt/images/static-images/singer4.png'}},
                            {id: 11, title:"Artist Name",PosterH:{url:'/assets/theme/vtt/images/static-images/singer2.png'}},
                            {id: 12, title:"Artist Name",PosterH:{url:'/assets/theme/vtt/images/static-images/singer1.png'}}];
