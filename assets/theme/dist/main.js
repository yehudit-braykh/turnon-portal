...
angular.module('turnon').run(['$templateCache', function($templateCache) {
  ...
  $templateCache.put('models/gainpoints/gainpoints.html',
    "<div class=gainpoints_page><div class=\"col-xs-12 gainpoints_header\"><div class=gainpoints_brand style=\"background-image: url('/assets/theme/src/images/headers/gainpoints.png')\"></div></div><div class=\"page_container col-xs-12\"><div class=center_image style=\"background-image: url('/assets/theme/src/images/bg/cover_image_basketball.png')\"><div class=sponser style=\"background-image: url('/assets/theme/src/images/headers/sponsers.png')\"></div><div class=grdainet></div></div><div class=barnds_container><div class=\"col-xs-12 barnd_item\" ng-repeat=\"brand in brands \"><div class=brand_background ng-click=go() style=\"background-image: url({{brand.cover_image}})\"><div class=barnd_logo style=\"background-image: url({{brand.logo}})\"></div></div></div></div></div></div>"
  );


  $templateCache.put('models/header_page/header.html',
    "<div class=header_page ng-controller=headerController><nav class=\"navbar navbar-default\"><div class=container-fluid><div class=navbar-header><button type=button class=\"navbar-toggle collapsed\" data-toggle=collapse data-target=#bs-example-navbar-collapse-1 aria-expanded=false><span class=sr-only>Toggle navigation</span> <span class=icon-bar></span> <span class=icon-bar></span> <span class=icon-bar></span></button><div class=\"dropdown drop-hamburger\" ng-click=open-manu() href=#><i class=\"fa fa-bars\" id=dropdownMenu1 aria-hidden=true data-toggle=dropdown></i><ul class=dropdown-menu aria-labelledby=dropdownMenu1><li class=li-style ng-click=\"go('newsfeed');\"><span>News Feed</span></li><li class=li-style ng-click=\"go('vod');\"><span>VOD</span></li><li class=li-style ng-click=\"go('discover');\"><span>Discover</span></li><li class=li-style ng-click=\"go('social');\"><span>TOSocial</span></li><li class=li-style ng-click=\"go('market');\"><span>Market Place</span></li><li class=li-style ng-click=\"go('gainpoints');\"><span>Gain Points</span></li></ul></div><div class=navbar-brand ng-click=\"go('/');\"></div></div><div class=\"collapse navbar-collapse\" id=bs-example-navbar-collapse-1><form class=\"navbar-form navbar-left\"><div class=form-group><input type=text class=form-control> <i class=\"fa fa-search\"></i></div><div class=\"logout-token {{login==true ? 'loged-in':''}}\"></div></form><div ng-show=\"login==false\" ng-click=Signin() class=sign-in>sign in</div><div ng-show=\"login==true\" class=profile-cover><div class=profile-name>sds</div><div class=profile-image></div></div></div></div></nav></div>"
  );
