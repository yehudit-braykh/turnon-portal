...
angular.module('clixtv').run(['$templateCache', function($templateCache) {
  ...
  $templateCache.put('ui/categories/view.category.html',
    "<div ng-if=!category><clix-loader size=large></clix-loader></div><div class=clix-category-page ng-if=category><clix-landing-page-banner background-image={{category.headerImage}}><banner-type>Category</banner-type><banner-title>{{category.title}}</banner-title><banner-sub-title>{{category.videos.videos.length}} {{category.videos.videos.length === 1 ? 'Video' : 'Videos'}}</banner-sub-title><banner-logo-container><img ng-src={{category.logo}}></banner-logo-container><banner-button-container><clix-tertiary-button ng-click=onFavoritePress()>{{isFavorite ? 'Added to Favorites' : 'Favorite'}}</clix-tertiary-button></banner-button-container></clix-landing-page-banner><div class=category-page-container><div class=category-page-content><div class=\"category-list-container hidden-sm hidden-xs hidden-md\"><div class=category-list-content><div class=category-list-title>More Categories</div><ul class=category-list><li ng-repeat=\"relatedCategory in categories.categories | orderBy: 'order'\" class=category-list-item ng-class=\"{'active-category': relatedCategory.title === category.title}\"><a ui-sref=\"category({ id: '{{relatedCategory.id}}' })\">{{relatedCategory.title}}</a></li></ul></div></div><div class=category-content><div class=category-filter-bar><div class=\"category-filter-container row\" ng-class=\"{'hidden-category-filters': (!category.videos.videos || category.videos.videos.length === 0)}\"><div class=\"filter-container col-xs-6\"><clix-dropdown options=filterOptions placeholder-text=\"Filter By\"></clix-dropdown></div><div class=\"filter-container col-xs-6\"><clix-dropdown options=sortOptions placeholder-text=\"Sort By\"></clix-dropdown></div></div></div><div class=empty-videos ng-if=\"!category.videos || !category.videos.videos || category.videos.videos.length === 0\"><div class=empty-category-container><div class=\"category-icon icon-lifestyle-icon\"></div><div class=empty-category-title>{{category.title}} videos are coming soon!</div><clix-is-logged-in><logged-in><div class=empty-category-desc>ClixTV can let you know when new<br>content is uploaded into this category!</div><div class=empty-category-notify-container><div class=empty-category-notify><div class=empty-category-notify-label>Notify Me!</div><div class=empty-category-switch><clix-switch ng-model=notify></clix-switch></div></div></div><div class=manage-settings-container><a ui-sref=\"account({ section: 'settings' })\">Manage notification settings</a></div></logged-in><not-logged-in><div class=empty-category-desc>Sign up now to make sure you are<br>notified when videos become available!</div><div class=authentication-container><clix-primary-button ng-click=onSignupPress()>Sign Up Now</clix-primary-button><div class=log-in-button><a ng-click=onLoginPress()>Log In Now</a></div></div></not-logged-in></clix-is-logged-in></div></div><div class=\"row clix-block-row\"><div class=\"clix-block-item col-xs-6 col-sm-4 col-md-3 col-lg-3 col-xl-2\" ng-repeat=\"video in category.videos.videos\"><clix-video-content-callout video=video></clix-video-content-callout></div></div></div></div></div></div>"
  );
  ...
  $templateCache.put('ui/common/banners/view.landing-page-banner.html',
    "<div class=clix-landing-page-banner><div class=landing-banner-background style=\"background-image: url('{{backgroundImage}}')\"></div><div class=landing-banner-overlay></div><div class=landing-banner-content><div class=banner-logo ng-transclude=bannerLogoContainer></div><div class=banner-type ng-transclude=bannerType></div><div class=banner-title ng-transclude=bannerTitle></div><div class=\"banner-subtitle visible-xs\" ng-transclude=bannerSubTitle></div><div class=banner-buttons-container><div class=\"banner-button banner-favorite-button\" ng-transclude=bannerButtonContainer></div><div class=\"banner-button banner-share-button\" ng-transclude=bannerShareButtonContainer ng-if=shareButtonProvided></div><div class=\"banner-subtitle hidden-xs\" ng-transclude=bannerSubTitle></div></div></div></div>"
  );
  ...
  $templateCache.put('ui/common/logos/view.brand-logo.html',
    "<div class=\"clix-asset-logo clix-brand-logo\"><div class=clix-logo-content-container style=\"background-image: url('{{brand.transparentThumbnail}}')\"></div></div>"
  );
  ...
  $templateCache.put('ui/footer/view.footer.html',
    "<footer class=clix-footer><div class=\"row footer-content\"><div class=\"col-xs-12 col-sm-3 footer-column\"><div class=footer-logo-container><img src=assets/theme/clixtv/dist/images/white-logo.svg class=clix-logo ng-if=!isBeta> <img src=assets/theme/clixtv/dist/images/clixtv-logo-white-horizontal-beta.svg class=clix-logo ng-if=isBeta></div></div><div class=\"col-xs-6 col-sm-3 footer-column\"><div class=footer-label>Company</div><ul class=footer-list><li><a href=#>What is ClixTV?</a></li><li><a href=#>Investor Relations</a></li><li><a href=#>Advertisers</a></li><li><a href=#>Jobs</a></li><li><a href=#>Press</a></li><li><a href=#>News</a></li></ul></div><div class=\"col-xs-6 col-sm-3 footer-column\"><div class=footer-label>Useful Links</div><ul class=footer-list><li><a ui-sref=charities>Charities</a></li><li><a ui-sref=stars>Stars</a></li><li><a href=#>Affiliates</a></li><li><a href=#>Rewards</a></li><li><a ui-sref=categories>Video Categories</a></li><li><a href=#>Help</a></li><li><a href=#>Contact</a></li></ul></div><div class=\"col-xs-12 col-sm-3 footer-column\"><div class=social-icons><a href=https://www.facebook.com/clixtvofficial/ class=social-icon target=_blank><i class=icon-facebook-logo></i> </a><a href=https://twitter.com/clixtvofficial class=social-icon target=_blank><i class=icon-twitter-logo></i> </a><a href=# class=social-icon target=_blank><i class=icon-youtube-logo></i> </a><a href=https://www.instagram.com/clixtv/ class=social-icon target=_blank><i class=icon-instagram-logo></i></a></div></div></div><div class=footer-legal-container><div class=footer-legal-column><a href=#>Legal</a></div><div class=footer-legal-column><a href=#>Cookies</a></div><div class=footer-legal-column>&copy; ClixTV, Inc</div></div></footer>"
  );
