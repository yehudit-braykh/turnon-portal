...
angular.module('clixtv').run(['$templateCache', function($templateCache) {
  ...
  $templateCache.put('ui/buttons/view.primary-button.html',
    "<div class=clix-primary-button ng-class=\"{'button-facebook': type === 'facebook', 'button-google': type === 'google', 'button-charity': type === 'charity', 'circle-button': circle === 'true', 'disabled-button': type === 'disabled'}\"><div ng-transclude></div></div>"
  );
  ...
  $templateCache.put('ui/common/container/view.video-content-callout-list.html',
    "<div class=\"clix-video-content-callout-list row\"><div class=\"video-content-callout-item {{gridClasses || 'col-xs-6 col-sm-4 col-md-3 col-lg-3 col-xl-2'}}\" ng-repeat=\"video in videos\"><clix-video-content-callout video=video></clix-video-content-callout></div></div>"
  );
  ...
  $templateCache.put('ui/common/search/view.offer-search-result-item.html',
    "<clix-base-search-result-item sref=\"brand-offer({ id: '{{offer.campaign.id}}', offerId: '{{offer.id}}' })\"><search-result-image><img ng-src={{offer.thumbnail}}></search-result-image><search-result-title>{{offer.title}}</search-result-title><search-result-subtitle>Offer</search-result-subtitle></clix-base-search-result-item>"
  );


  $templateCache.put('ui/common/search/view.search-dropdown.html',
    "<div class=clix-search-dropdown ng-if=\"(results || searching || empty) && !forceHide\"><div ng-if=searching><clix-loader size=small></clix-loader></div><div class=dropdown-empty-results-container ng-if=\"empty && !searching\"><div class=dropdown-empty-results-message>No results found for &ldquo;{{term}}&rdquo;</div><div class=dropdown-empty-results-desc>Please make sure you spelled everything correctly, or use different words.</div></div><div ng-if=results.charities><div ng-repeat=\"charity in results.charities\"><clix-charity-search-result-item charity=charity></clix-charity-search-result-item></div></div><div ng-if=results.brands><div ng-repeat=\"brand in results.brands\"><clix-brand-search-result-item brand=brand></clix-brand-search-result-item></div></div><div ng-if=results.offers><div ng-repeat=\"offer in results.offers\"><clix-offer-search-result-item offer=offer></clix-offer-search-result-item></div></div></div>"
  );
  ...
  $templateCache.put('ui/footer/view.footer.html',
    "<footer class=clix-footer><div class=\"row footer-content\"><div class=\"col-xs-12 col-sm-3 footer-column\"><div class=footer-logo-container><img src=assets/theme/clixtv/dist/images/white-logo.svg class=clix-logo ng-if=!isBeta> <img src=assets/theme/clixtv/dist/images/clixtv-logo-white-horizontal-beta.svg class=clix-logo ng-if=isBeta></div></div><div class=\"col-xs-6 col-sm-3 footer-column\"><div class=footer-label>Company</div><ul class=footer-list><li><a ui-sref=about>What is ClixTV?</a></li><li><a ui-sref=\"contact({ section: 'investor-relations' })\">Investor Relations</a></li><li><a ui-sref=\"contact({ section: 'advertisers' })\">Advertisers</a></li><li><a ui-sref=\"contact({ section: 'jobs' })\">Jobs</a></li><li><a ui-sref=\"contact({ section: 'press' })\">Press</a></li><li><a ui-sref=\"contact({ section: 'news' })\">News</a></li></ul></div><div class=\"col-xs-6 col-sm-3 footer-column\"><div class=footer-label>Useful Links</div><ul class=footer-list><li><a ui-sref=charities>Charities</a></li><li><a ui-sref=stars>Stars</a></li><li><a ui-sref=\"contact({ section: 'affiliates' })\">Affiliates</a></li><li><a ui-sref=\"contact({ section: 'rewards' })\">Rewards</a></li><li><a ui-sref=categories>Video Categories</a></li><li><a ui-sref=\"contact({ section: 'help' })\">Help</a></li><li><a ui-sref=\"contact({ section: '' })\">Contact</a></li></ul></div><div class=\"col-xs-12 col-sm-3 footer-column\"><div class=social-icons><a href=https://www.facebook.com/clixtvofficial/ class=social-icon target=_blank><i class=icon-facebook-logo></i> </a><a href=https://twitter.com/clixtvofficial class=social-icon target=_blank><i class=icon-twitter-logo></i> </a><a href=# class=social-icon target=_blank><i class=icon-youtube-logo></i> </a><a href=https://www.instagram.com/clixtv/ class=social-icon target=_blank><i class=icon-instagram-logo></i></a></div></div></div><div class=footer-legal-container><div class=footer-legal-column><a href=#>Legal</a></div><div class=footer-legal-column><a href=#>Cookies</a></div><div class=footer-legal-column>&copy; ClixTV, Inc</div></div></footer>"
  );
