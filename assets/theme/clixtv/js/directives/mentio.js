...
clixApp.directive('mentio', ['mentioUtil', '$document', '$compile', '$log', '$timeout',
            ...
            controller: ["$scope", "$timeout", "$attrs", function($scope, $timeout, $attrs) {
                ...
                $scope.defaultSearch = function(locals) {
                    ...
                    angular.forEach($scope.items, function(item) {
                        if (item.name.toUpperCase().indexOf(locals.term.toUpperCase()) >= 0) {
                            results.push(item);
                        }
                    });
                ...
                $scope.defaultSelect = function(locals) {
                    $scope.tags.push(locals.item.id);
                    return $scope.defaultTriggerChar + locals.item.name;
                };
    ...
    .directive('mentioMenu', ['mentioUtil', '$rootScope', '$log', '$window', '$document',
        ...
        return {
            ...
            templateUrl: function(tElement, tAttrs) {
                return tAttrs.mentioTemplateUrl !== undefined ? tAttrs.mentioTemplateUrl : 'assets/theme/clixtv/html/directives/mentio.html';
            },
...
clixApp.factory('mentioUtil', ["$window", "$location", "$anchorScroll", "$timeout", function ($window, $location, $anchorScroll, $timeout) {
...
/*
clixApp.run(["$templateCache", function($templateCache) {$templateCache.put("mentio-menu.tpl.html","<style>\n.scrollable-menu {\n    height: auto;\n    max-height: 300px;\n    overflow: auto;\n}\n\n.menu-highlighted {\n    font-weight: bold;\n}\n</style>\n<ul class=\"dropdown-menu scrollable-menu\" style=\"display:block\">\n    <li mentio-menu-item=\"item\" ng-repeat=\"item in items track by $index\">\n  <div class=\"item-pic\" style=\"style:\'url>      <a class=\"text-primary\" ng-bind-html=\"item.name | mentioHighlight:typedTerm:\'menu-highlighted\' | unsafe\"></a>\n    </li>\n</ul>");}]);
*/
