var s = null;
vttApp.controller('seasonController', function seasonController ($scope, $location, $routeParams, categoriesFactory, videoFactory, $http, $log) {
    s = $scope;

    $scope.search='';

    $scope.videoId=$routeParams.episodeId;
