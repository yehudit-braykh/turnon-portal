var p = null;
vttApp.controller('programaController', function programaController ($scope, $location, $routeParams, categoriesFactory, videoFactory, $http, $log) {
    p = $scope;

    $scope.search='';

    $scope.videoId=$routeParams.ProgrmaId;
    ...
    videoFactory.getVideoById($scope.videoId).then(function(data){
        ...
        $scope.video.seasons= 23;
        $scope.video.episodes = 147;
