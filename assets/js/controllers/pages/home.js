...
vttApp.controller('homeController', function homeController ($scope, $location, videoFactory, $http, $log) {
    ...
    $scope.videos=[{id: 1,categories:[{name:"free"}], PosterH:{url:'/assets//images/static-images/carousel1.png'}},
  ...
  $scope.slider=[{id: 1,title:"Titulo del Programa", description:"The official Wikipedia Android app is designed to help you find, discover, and explore knowledge on Wikipedia. Settle a bet with a friend search…", PosterH:{url:'/assets//images/static-images/slider2.png'}},
                {id: 2,title:"Titulo del Programa", description:"The official Wikipedia Android app is designed to help you find, discover, and explore knowledge on Wikipedia. Settle a bet with a friend search…",categories:[{name:"free"}],PosterH:{url:'/assets//images/static-images/slider1.png'}},
                {id: 3, title:"Titulo del Programa", description:"The official Wikipedia Android app is designed to help you find, discover, and explore knowledge on Wikipedia. Settle a bet with a friend search…",categories:[{name:"member"}],PosterH:{url:'/assets//images/static-images/home-slider/slide1.png'}},
                {id: 4, title:"Titulo del Programa", description:"The official Wikipedia Android app is designed to help you find, discover, and explore knowledge on Wikipedia. Settle a bet with a friend search…",categories:[{name:"free"}],PosterH:{url:'/assets//images/static-images/home-slider/slide2.png'}}];

    $scope.featuredVideos=[{id: 1, categories:[{name:"member"}],PosterH:{url:'/assets//images/static-images/carousel5.png'}},
                {id: 2, categories:[{name:"member"}],PosterH:{url:'/assets//images/static-images/carousel4.png'}},
                {id: 3, categories:[{name:"free"}],PosterH:{url:'/assets//images/static-images/carousel7.png'}},
                {id: 4, categories:[{name:"free"}],PosterH:{url:'/assets//images/static-images/carousel3.png'}},
                {id: 5, categories:[{name:"member"}],PosterH:{url:'/assets//images/static-images/carousel2.png'}},
                {id: 6, categories:[{name:"free"}],PosterH:{url:'/assets//images/static-images/carousel1.png'}},
                {id: 7, categories:[{name:"member"}],PosterH:{url:'/assets//images/static-images/carousel6.png'}},
                {id: 8, categories:[{name:"member"}],PosterH:{url:'/assets//images/static-images/carousel2.png'}},
                {id: 9, categories:[{name:"free"}],PosterH:{url:'/assets//images/static-images/carousel3.png'}},
                {id: 10,categories:[{name:"free"}], PosterH:{url:'/assets//images/static-images/carousel4.png'}}];
