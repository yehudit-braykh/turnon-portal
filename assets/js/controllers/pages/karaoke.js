...
vttApp.controller('karaokeController', function karaokeController ($scope, $location, categoriesFactory, videoFactory, $http, $log) {
    ...
    $scope.playlist=[{id: 1, title:"Clasicos",PosterH:{url:'/assets//images/static-images/album5.png'},name:'hey'},
                ...
                $scope.singers=[{id: 1, title:"Artist Name",PosterH:{url:'/assets//images/static-images/singer5.png'},name:'hey'},
                            {id: 2, title:"Artist Name",PosterH:{url:'/assets//images/static-images/singer4.png'},name:'hey'},
                            {id: 3, title:"Artist Name",PosterH:{url:'/assets//images/static-images/singer1.png'},name:'hey'},
                            {id: 4, title:"Artist Name",PosterH:{url:'/assets//images/static-images/singer3.png'},name:'hey'},
                            {id: 5, title:"Artist Name",PosterH:{url:'/assets//images/static-images/singer2.png'},name:'hey'},
                            {id: 6, title:"Artist Name",PosterH:{url:'/assets//images/static-images/singer1.png'},name:'hey'},
                            {id: 7, title:"Artist Name",PosterH:{url:'/assets//images/static-images/singer5.png'},name:'bye'},
                            {id: 8, title:"Artist Name",PosterH:{url:'/assets//images/static-images/singer2.png'},name:'bye'},
                            {id: 9, title:"Artist Name",PosterH:{url:'/assets//images/static-images/singer3.png'},name:'bye'},
                            {id: 10,title:"Artist Name", PosterH:{url:'/assets//images/static-images/singer4.png'},name:'bye'},
                            {id: 11, title:"Artist Name",PosterH:{url:'/assets//images/static-images/singer2.png'},name:'bye'},
                            {id: 12, title:"Artist Name",PosterH:{url:'/assets//images/static-images/singer1.png'},name:'bye'}];



                            $scope.select = function(cat,index) {
                            ...
                            $scope.sortbyfunc = function(sort) {
                                $scope.sortby = sort;
                            };

                $scope.sortby='';
                $scope.changeclass='singers';
                $scope.collection=$scope["singers"];
